...
const login = () => {
  ...
  return (
    <View className="flex-1 gap-3 justify-center px-3">
      ...
      <AppInput error={formHandler.error?.email} onChange={e => formHandler.value.email = e} icon={<Ionicons name="person-circle-outline" size={25} color={"#9ca3af"} />} placeholder={"Email"} />
